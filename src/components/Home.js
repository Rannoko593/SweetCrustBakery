...
const Home = () => {
  ...
  return (
    <div>
      ...
      <h2 className="text-center mb-4" id="products">
        <i className="fas fa-bread-slice me-2"></i>Our Products
      </h2>
              ...
              <div key={product.id} className="col-md-4 col-sm-6 mb-4">
                <div className="card h-100">
                  {product.image_url ? (
                    ...
                    <img
                      src="https://via.placeholder.com/250?text=No+Image"
                      className="card-img-top"
                      alt="No Image"
                    />
                  )}
                  <div className="card-body">
                    ...
                    <p className="card-text"><strong>Price:</strong> M{price.toFixed(2)}</p>
                  </div>
                </div>
              </div>
            );
